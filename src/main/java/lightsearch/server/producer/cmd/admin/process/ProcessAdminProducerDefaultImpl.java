...
@Service("processorAdminProducerAdminCommandResult")
public class ProcessAdminProducerDefaultImpl implements ProcessAdminProducer<AdminCommandResult> {

    private final ApplicationContext ctx;

    public ProcessAdminProducerDefaultImpl(ApplicationContext ctx) {
        this.ctx = ctx;
    }
