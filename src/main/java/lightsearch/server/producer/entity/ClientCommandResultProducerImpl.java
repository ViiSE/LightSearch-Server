...
@Service("clientCommandResultProducer")
public class ClientCommandResultProducerImpl implements ClientCommandResultProducer {

    private final ApplicationContext ctx;

    public ClientCommandResultProducerImpl(ApplicationContext ctx) {
        this.ctx = ctx;
    }
