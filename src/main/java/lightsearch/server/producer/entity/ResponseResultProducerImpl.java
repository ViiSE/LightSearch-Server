...
@Service("responseResultProducer")
public class ResponseResultProducerImpl implements ResponseResultProducer {

    private final ApplicationContext ctx;

    public ResponseResultProducerImpl(ApplicationContext ctx) {
        this.ctx = ctx;
    }
