...
@Component("commandCheckerClientUnbind")
public class CommandCheckerClientUnbindImpl implements Checker<ClientCommand> {

    private final LightSearchChecker checker;

    public CommandCheckerClientUnbindImpl(LightSearchChecker checker) {
