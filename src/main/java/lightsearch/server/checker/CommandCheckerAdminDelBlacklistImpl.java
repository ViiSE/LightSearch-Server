...
public class CommandCheckerAdminDelBlacklistImpl implements Checker<AdminCommand> {

    private final BlacklistService<String> blacklistService;
    private final LightSearchChecker checker;

    public CommandCheckerAdminDelBlacklistImpl(BlacklistService<String> blacklistService, LightSearchChecker checker) {
    ...
    public void check(AdminCommand cmd) throws CheckerException {
        AdminCommandDelBlacklistImpl command = (AdminCommandDelBlacklistImpl) cmd;
