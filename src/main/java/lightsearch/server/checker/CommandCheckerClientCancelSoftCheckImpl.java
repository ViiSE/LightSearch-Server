...
@Component("commandCheckerClientCancelSoftCheck")
public class CommandCheckerClientCancelSoftCheckImpl implements Checker<ClientCommand> {

    private final LightSearchChecker checker;

    public CommandCheckerClientCancelSoftCheckImpl(LightSearchChecker checker) {
