...
@Component("commandCheckerClientOpenSoftCheck")
public class CommandCheckerClientOpenSoftCheckImpl implements Checker<ClientCommand> {

    private final LightSearchChecker checker;

    public CommandCheckerClientOpenSoftCheckImpl(LightSearchChecker checker) {
