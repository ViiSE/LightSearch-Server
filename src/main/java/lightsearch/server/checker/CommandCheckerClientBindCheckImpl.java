...
@Component("commandCheckerClientBindCheck")
public class CommandCheckerClientBindCheckImpl implements Checker<ClientCommand> {

    private final LightSearchChecker checker;

    public CommandCheckerClientBindCheckImpl(LightSearchChecker checker) {
