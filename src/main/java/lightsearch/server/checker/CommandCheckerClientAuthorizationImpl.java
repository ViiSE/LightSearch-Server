...
public class CommandCheckerClientAuthorizationImpl implements Checker<ClientCommand> {

    private final Checker<String> commandChecker;
    private final LightSearchChecker checker;

    public CommandCheckerClientAuthorizationImpl(
            @Qualifier("commandCheckerClientDefault") Checker<String> commandChecker,
