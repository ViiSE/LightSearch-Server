...
@Component("commandCheckerClientBind")
public class CommandCheckerClientBindImpl implements Checker<ClientCommand> {

    private final LightSearchChecker checker;

    public CommandCheckerClientBindImpl(LightSearchChecker checker) {
