 ...
 * @author ViiSE
 */
@Component("changePassProcess")
public class ChangePassProcess implements AdminProcess<AdminCommandResult> {
    ...
    public ChangePassProcess(
            AdminCommandResultProducer admCmdResProducer,
            @Qualifier("adminPasswordPropertyCreator") PropertyCreator<String, AdminCommand> propertyCreator,
            PropertiesChanger<Void, Property<String>> propertiesChanger,
            @Qualifier("commandCheckerChangePass") Checker<AdminCommand> checker) {
    ...
    synchronized public AdminCommandResult apply(AdminCommand command) {
        try {
            ...
            return admCmdResProducer.getAdminCommandResultSimpleInstance(
                    true,
                    "Admin password has been changed. Need restart server for changed apply.");
