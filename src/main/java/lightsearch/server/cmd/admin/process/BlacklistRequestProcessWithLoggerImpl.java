...
@Component("blacklistRequestProcessWithLogger")
public class BlacklistRequestProcessWithLoggerImpl implements AdminProcess<AdminCommandResult> {

    private final LoggerServer logger;
    private final AdminProcess<AdminCommandResult> adminProcess;

    public BlacklistRequestProcessWithLoggerImpl(
            LoggerServer logger,
            @Qualifier("blacklistRequestProcess") AdminProcess<AdminCommandResult> adminProcess) {
        this.logger = logger;
