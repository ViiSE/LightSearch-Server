...
@Component("updateSoftCheckProductsProcess")
public class UpdateSoftCheckProductsProcess implements ClientProcess<ClientCommandResult> {
    ...
    public UpdateSoftCheckProductsProcess(
            @Qualifier("commandCheckerClientUpdateSoftCheckProducts") Checker<ClientCommand> checker,
    ...
    public ClientCommandResult apply(ClientCommand command) {
        try {
            ...
            DatabaseCommandMessage dbCmdMessage =
                    dbCmdMsgProducer.getDatabaseCommandMessageUpdateSoftCheckProductsWindowsJSONInstance(command);
