...
@Component("confirmSoftCheckProductsProcess")
public class ConfirmSoftCheckProductsProcess implements ClientProcess<ClientCommandResult> {
    ...
    public ConfirmSoftCheckProductsProcess(
            @Qualifier("commandCheckerClientConfirmSoftCheckProducts") Checker<ClientCommand> checker,
