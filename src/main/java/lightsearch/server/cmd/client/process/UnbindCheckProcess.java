...
@Component("unbindCheckProcess")
public class UnbindCheckProcess implements ClientProcess<ClientCommandResult> {
    ...
    public UnbindCheckProcess(
            @Qualifier("commandCheckerClientUnbindCheck") Checker<ClientCommand> checker,
    ...
    public ClientCommandResult apply(ClientCommand command) {
        try {
            ...
            DatabaseCommandMessage dbCmdMessage =
                    dbCmdMsgProducer.getDatabaseCommandMessageUnbindCheckWindowsJSONInstance(command);
