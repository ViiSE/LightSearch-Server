...
@Component("closeSoftCheckProcess")
public class CloseSoftCheckProcess implements ClientProcess<ClientCommandResult> {
    ...
    public CloseSoftCheckProcess(
            @Qualifier("commandCheckerClientCloseSoftCheck") Checker<ClientCommand> checker,
    ...
    public ClientCommandResult apply(ClientCommand command) {
        try {
            ...
            return resultProducer.getClientCommandResultCloseSoftCheckInstance(cmdRes);
