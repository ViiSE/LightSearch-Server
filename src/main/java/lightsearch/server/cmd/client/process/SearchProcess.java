...
public class SearchProcess implements ClientProcess<ClientCommandResult> {
    ...
    public SearchProcess(
            @Qualifier("commandCheckerClientSearch") Checker<ClientCommand> checker,
    ...
    public ClientCommandResult apply(ClientCommand command) {
        try {
            ...
            DatabaseCommandMessage dbCmdMessage =
                    dbCmdMsgProducer.getDatabaseCommandMessageSearchWindowsJSONInstance(command);
