...
@Component("cancelSoftCheckProcess")
public class CancelSoftCheckProcess implements ClientProcess<ClientCommandResult> {
    ...
    public CancelSoftCheckProcess(
            @Qualifier("commandCheckerClientCancelSoftCheck") Checker<ClientCommand> checker,
