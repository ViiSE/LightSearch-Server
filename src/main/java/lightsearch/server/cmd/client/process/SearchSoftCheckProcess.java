...
@Component("searchSoftCheckProcess")
public class SearchSoftCheckProcess implements ClientProcess<ClientCommandResult> {
    ...
    public SearchSoftCheckProcess(
            @Qualifier("commandCheckerClientSearchSoftCheck") Checker<ClientCommand> checker,
    ...
    public ClientCommandResult apply(ClientCommand command) {
        try {
            ...
            DatabaseCommandMessage dbCmdMessage =
                    dbCmdMsgProducer.getDatabaseCommandMessageSearchSoftCheckDefaultWindowsJSONInstance(command);
