...
@Component("unbindProcess")
public class UnbindProcess implements ClientProcess<ClientCommandResult> {
    ...
    public UnbindProcess(
            @Qualifier("commandCheckerClientUnbind") Checker<ClientCommand> checker,
    ...
    public ClientCommandResult apply(ClientCommand command) {
        try {
            ...
            DatabaseCommandMessage dbCmdMessage =
                    dbCmdMsgProducer.getDatabaseCommandMessageUnbindWindowsJSONInstance(command);
