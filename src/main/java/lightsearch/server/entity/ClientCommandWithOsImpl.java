...
@Component("clientCommandWithOs")
@Scope("prototype")
public class ClientCommandWithOsImpl implements ClientCommand {

    private final ClientCommand clientCommand;
    private final String os;

    public ClientCommandWithOsImpl(ClientCommand clientCommand, String os) {
