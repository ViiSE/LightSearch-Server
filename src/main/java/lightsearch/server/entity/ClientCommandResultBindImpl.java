...
@Component("clientCommandResultBind")
@Scope("prototype")
public class ClientCommandResultBindImpl implements ClientCommandResult {

    private final ClientCommandResult clientCommandResult;

    public ClientCommandResultBindImpl(ClientCommandResult clientCommandResult) {
