...
@Component("clientCommandResultUnbind")
@Scope("prototype")
public class ClientCommandResultUnbindImpl implements ClientCommandResult {

    private final ClientCommandResult clientCommandResult;

    public ClientCommandResultUnbindImpl(ClientCommandResult clientCommandResult) {
