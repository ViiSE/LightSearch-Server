...
@Component("clientCommandWithModel")
@Scope("prototype")
public class ClientCommandWithModelImpl implements ClientCommand {

    private final ClientCommand clientCommand;
    private final String model;

    public ClientCommandWithModelImpl(ClientCommand clientCommand, String model) {
    ...
    public Object formForSend() {
        ...
        clientCommandDTO.setModel(model);
