...
@Component("clientCommandWithTK")
@Scope("prototype")
public class ClientCommandWithTKImpl implements ClientCommand {

    private final ClientCommand clientCommand;
    private final String TK;

    public ClientCommandWithTKImpl(ClientCommand clientCommand, String TK) {
