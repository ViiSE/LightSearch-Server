...
@Component("clientCommandResultCancelSoftCheck")
@Scope("prototype")
public class ClientCommandResultCancelSoftCheckImpl implements ClientCommandResult {

    private final ClientCommandResult clientCommandResult;

    public ClientCommandResultCancelSoftCheckImpl(ClientCommandResult clientCommandResult) {
