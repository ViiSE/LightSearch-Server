...
@Component("clientCommandWithUsername")
@Scope("prototype")
public class ClientCommandWithUsernameImpl implements ClientCommand {

    private final ClientCommand clientCommand;
    private final String username;

    public ClientCommandWithUsernameImpl(ClientCommand clientCommand, String username) {
