...
@Component("clientCommandResultSkladList")
@Scope("prototype")
public class ClientCommandResultSkladListImpl implements ClientCommandResult {

    private final ClientCommandResult clientCommandResult;

    public ClientCommandResultSkladListImpl(ClientCommandResult clientCommandResult) {
