...
@Component("jwtTokenHeaderDefault")
@Scope("prototype")
public class JWTTokenHeaderDefaultImpl implements JWTTokenHeader {

    private final ObjectMapper mapper;
    private final String token;

    public JWTTokenHeaderDefaultImpl(ObjectMapper mapper, String token) {
        this.mapper = mapper;
        this.token = token;
    }
    ...
    public Object formForSend() {
        try {
            ...
            System.out.println("TIME=" + jwtTokenHeaderDTO.getValidTo());
            System.out.println("===============================");
