...
@Component("clientCommandResultUnbindCheck")
@Scope("prototype")
public class ClientCommandResultUnbindCheckImpl implements ClientCommandResult {

    private final ClientCommandResult clientCommandResult;

    public ClientCommandResultUnbindCheckImpl(ClientCommandResult clientCommandResult) {
