...
@Component("clientCommandResultCloseSoftCheck")
@Scope("prototype")
public class ClientCommandResultCloseSoftCheckImpl implements ClientCommandResult {

    private final ClientCommandResult clientCommandResult;

    public ClientCommandResultCloseSoftCheckImpl(ClientCommandResult clientCommandResult) {
