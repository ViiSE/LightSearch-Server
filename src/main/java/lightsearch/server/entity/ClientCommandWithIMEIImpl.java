...
@Component("clientCommandWithIMEI")
@Scope("prototype")
public class ClientCommandWithIMEIImpl implements ClientCommand {

    private final ClientCommand clientCommand;
    private final String IMEI;

    public ClientCommandWithIMEIImpl(ClientCommand clientCommand, String IMEI) {
