...
@Component("responseResultRowMapperFirebird")
public class ResponseResultRowMapperFirebird implements RowMapper<ResponseResult> {
    ...
    public ResponseResultRowMapperFirebird(
    ...
    public ResponseResult mapRow(ResultSet rs, int i) throws SQLException {
        try {
            ...
            LocalDateTime dateTime = LocalDateTime.parse(rs.getString("DDOC"), formatter);
