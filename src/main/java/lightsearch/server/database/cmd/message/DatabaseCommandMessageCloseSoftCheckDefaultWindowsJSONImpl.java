...
@Component("databaseCommandMessageCloseSoftCheckDefaultWindowsJSON")
@Scope("prototype")
public class DatabaseCommandMessageCloseSoftCheckDefaultWindowsJSONImpl implements DatabaseCommandMessage {
    ...
    public DatabaseCommandMessageCloseSoftCheckDefaultWindowsJSONImpl(ClientCommand clientCommand) {
