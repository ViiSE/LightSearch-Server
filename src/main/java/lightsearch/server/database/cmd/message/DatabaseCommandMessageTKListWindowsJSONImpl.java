...
@Component("databaseCommandMessageTKListWindowsJSON")
@Scope("prototype")
public class DatabaseCommandMessageTKListWindowsJSONImpl implements DatabaseCommandMessage {

    private final String command;

    public DatabaseCommandMessageTKListWindowsJSONImpl(ClientCommand clientCommand) {
