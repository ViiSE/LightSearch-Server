...
@Component("databaseCommandMessageSearchSoftCheckWindowsJSON")
@Scope("prototype")
public class DatabaseCommandMessageSearchSoftCheckWindowsJSONImpl implements DatabaseCommandMessage {

    private final String command;
    private final String barcode;
    private final String username;

    public DatabaseCommandMessageSearchSoftCheckWindowsJSONImpl(ClientCommand clientCommand) {
