...
@Component("databaseCommandMessageBindWindowsJSON")
@Scope("prototype")
public class DatabaseCommandMessageBindWindowsJSONImpl implements DatabaseCommandMessage {
    ...
    public DatabaseCommandMessageBindWindowsJSONImpl(ClientCommand clientCommand) {
