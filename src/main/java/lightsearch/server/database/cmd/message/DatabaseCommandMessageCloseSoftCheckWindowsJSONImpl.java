...
@Component("databaseCommandMessageCloseSoftCheckWindowsJSON")
@Scope("prototype")
public class DatabaseCommandMessageCloseSoftCheckWindowsJSONImpl implements DatabaseCommandMessage {
    ...
    public DatabaseCommandMessageCloseSoftCheckWindowsJSONImpl(ClientCommand clientCommand) {
        ...
        this.delivery  = cmdDTO.getDelivery();
    }
    ...
    public String asString() {
        return "{\r\n"
                ...
                + "\"" + DatabaseCommandMessages.DELIVERY + "\":\"" + delivery + "\"\r\n"
                + "}";
    }
}
