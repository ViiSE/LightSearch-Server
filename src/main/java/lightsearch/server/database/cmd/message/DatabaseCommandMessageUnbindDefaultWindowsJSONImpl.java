...
@Component("databaseCommandMessageUnbindDefaultWindowsJSON")
@Scope("prototype")
public class DatabaseCommandMessageUnbindDefaultWindowsJSONImpl implements DatabaseCommandMessage {

    private final String command;
    private final String factoryBarcode;
    private final String userIdent;

    public DatabaseCommandMessageUnbindDefaultWindowsJSONImpl(ClientCommand clientCommand) {
