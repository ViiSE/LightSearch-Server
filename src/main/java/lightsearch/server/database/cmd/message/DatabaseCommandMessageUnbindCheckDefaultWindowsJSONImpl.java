...
@Component("databaseCommandMessageUnbindCheckDefaultWindowsJSON")
@Scope("prototype")
public class DatabaseCommandMessageUnbindCheckDefaultWindowsJSONImpl implements DatabaseCommandMessage {

    private final String command;
    private final String barcode;

    public DatabaseCommandMessageUnbindCheckDefaultWindowsJSONImpl(ClientCommand clientCommand) {
