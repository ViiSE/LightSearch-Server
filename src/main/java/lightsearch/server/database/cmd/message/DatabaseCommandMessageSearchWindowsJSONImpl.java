...
@Component("databaseCommandMessageSearchWindowsJSON")
@Scope("prototype")
public class DatabaseCommandMessageSearchWindowsJSONImpl implements DatabaseCommandMessage {
    ...
    public DatabaseCommandMessageSearchWindowsJSONImpl(ClientCommand clientCommand) {
        ...
        this.sklad = cmdDTO.getSklad();
        this.TK = cmdDTO.getTK();
    }
    ...
    public String asString() {
        return "{\r\n"
                ...
                + "\"" + DatabaseCommandMessages.SKLAD + "\":\"" + sklad + "\",\r\n"
                + "\"" + DatabaseCommandMessages.TK + "\":\"" + TK + "\"\r\n"
                + "}";
    }
}
