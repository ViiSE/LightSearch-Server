...
@Component("databaseCommandMessageCancelSoftCheckWindowsJSON")
@Scope("prototype")
public class DatabaseCommandMessageCancelSoftCheckWindowsJSONImpl implements DatabaseCommandMessage {
    
    private final String command;
    private final String userIdent;
    private final String cardCode;

    public DatabaseCommandMessageCancelSoftCheckWindowsJSONImpl(ClientCommand clientCommand) {
