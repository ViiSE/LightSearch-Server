 ...
 * @author ViiSE
 */
@Component("databaseCommandMessageConnectionWindowsJSON")
@Scope("prototype")
public class DatabaseCommandMessageConnectionWindowsJSONImpl implements DatabaseCommandMessage {

    private final String command;
    private final String username;
    private final String userIdent;
    
    public DatabaseCommandMessageConnectionWindowsJSONImpl(ClientCommand clientCommand) {
