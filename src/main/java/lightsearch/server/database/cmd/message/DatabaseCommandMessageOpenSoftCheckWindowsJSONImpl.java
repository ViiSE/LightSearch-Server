...
@Component("databaseCommandMessageOpenSoftCheckWindowsJSON")
@Scope("prototype")
public class DatabaseCommandMessageOpenSoftCheckWindowsJSONImpl implements DatabaseCommandMessage {

    private final String command;
    private final String userIdent;
    private final String cardCode;
    
    public DatabaseCommandMessageOpenSoftCheckWindowsJSONImpl(ClientCommand clientCommand) {
