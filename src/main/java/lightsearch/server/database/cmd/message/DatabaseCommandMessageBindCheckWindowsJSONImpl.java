...
@Component("databaseCommandMessageBindCheckWindowsJSON")
@Scope("prototype")
public class DatabaseCommandMessageBindCheckWindowsJSONImpl implements DatabaseCommandMessage {

    private final String command;
    private final String barcode;
    private final String checkEan13;

    public DatabaseCommandMessageBindCheckWindowsJSONImpl(ClientCommand clientCommand) {
        ...
        this.checkEan13 = cmdDTO.getCheckEan13() ? "true" : "false";
    }
    ...
    public String asString() {
        return "{\r\n"
                ...
                + "\"" + DatabaseCommandMessages.CHECK_EAN_13 + "\":\"" + checkEan13 + "\"\r\n"
                + "}";
    }
}
