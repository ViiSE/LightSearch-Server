...
@Component("databaseCommandMessageUnbindCheckWindowsJSON")
@Scope("prototype")
public class DatabaseCommandMessageUnbindCheckWindowsJSONImpl implements DatabaseCommandMessage {

    private final String command;
    private final String barcode;

    public DatabaseCommandMessageUnbindCheckWindowsJSONImpl(ClientCommand clientCommand) {
