...
public class JWTTokenHeaderProducerIntegrationTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void setUpClass() {
        testBegin(JWTTokenHeaderProducerImpl.class);
    }
    ...
    public void getJWTTokenHeaderDefaultInstance(String token) {
        ...
        assertTrue(jwtTokenHeader instanceof JWTTokenHeaderImpl);
    }

    @AfterClass
    public void teardownClass() {
        testEnd(JWTTokenHeaderProducerImpl.class);
    }
}
