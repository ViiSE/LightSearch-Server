...
public class ClientCommandProducerIntegrationTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void setUpClass() {
        testBegin(ClientCommandProducerImpl.class);
    }
    ...
    @Test
    @Parameters({"cmdName", "encData"})
    public void getClientCommandWithEncryptedDataInstance(String cmdName, String encData) {
        testMethod("getClientCommandWithEncryptedDataInstance()");

        ClientCommand command = producer.getClientCommandWithEncryptedDataInstance(
                producer.getClientCommandSimpleInstance(cmdName),
                encData);
        System.out.println("instance: " + command);
        assertTrue(command instanceof ClientCommandWithEncryptedDataImpl);
    }

    @AfterClass
    public void teardownClass() {
        testEnd(ClientCommandProducerImpl.class);
    }
}
