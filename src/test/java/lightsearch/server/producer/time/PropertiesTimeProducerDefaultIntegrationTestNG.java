...
import lightsearch.server.time.DateTimeComparatorDefaultImpl;
...
public class PropertiesTimeProducerDefaultIntegrationTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void setUpClass() {
        testBegin(DateTimeComparatorProducerDefaultImpl.class);
    }
    ...
    public void getDatabaseRecordIdentifierDefaultInstance(String pattern) {
        ...
        assertTrue(dtc instanceof DateTimeComparatorDefaultImpl);
    }

    @AfterClass
    public void teardownClass() {
        testEnd(DateTimeComparatorProducerDefaultImpl.class);
    }
}
