...
public class RowMapperProducerFirebirdIntegrationTestNG extends AbstractTestNGSpringContextTests {

    @Autowired
    @Qualifier("rowMapperProducerFirebird")
    ...
    public void getResponseResultRowMapperInstance() {
        ...
        assertTrue(mapper instanceof ResponseResultRowMapperFirebird);
    }
