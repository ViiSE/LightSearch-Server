...
public class ProcessAdminProducerIntegrationTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void setUpClass() {
        testBegin(ProcessAdminProducerImpl.class);
    }
    ...
    public void teardownClass() {
        testEnd(ProcessAdminProducerImpl.class);
    }
}
