...
public class DatabaseCommandMessageConfirmSoftCheckProductsWindowsJSONTestNG {
    ...
    public void setUpClass(String userIdent, String cardCode) {
        ...
        dbCmdMessage = new DatabaseCommandMessageConfirmSoftCheckProductsWindowsJSONImpl(clientCommand);

        testBegin(DatabaseCommandMessageConfirmSoftCheckProductsWindowsJSONImpl.class);
    }
    ...
    public void teardownClass() {
        testEnd(DatabaseCommandMessageConfirmSoftCheckProductsWindowsJSONImpl.class);
    }
}
