...
public class DatabaseCommandMessageOpenSoftCheckDefaultWindowsJSONTestNG {
    ...
    public void setUpClass(String userIdent, String cardCode) {
        String command = ClientCommands.OPEN_SOFT_CHECK;
        ...
        dbCmdMessage = new DatabaseCommandMessageOpenSoftCheckDefaultWindowsJSONImpl(clientCommand);

        testBegin(DatabaseCommandMessageOpenSoftCheckDefaultWindowsJSONImpl.class);
    }
    ...
    public void teardownClass() {
        testEnd(DatabaseCommandMessageOpenSoftCheckDefaultWindowsJSONImpl.class);
    }
}
