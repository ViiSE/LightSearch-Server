...
public class DatabaseCommandMessageCancelSoftCheckDefaultWindowsJSONTestNG {
    ...
    public void setUpClass(String userIdent, String cardCode) {
        ...
        dbCmdMessage = new DatabaseCommandMessageCancelSoftCheckDefaultWindowsJSONImpl(clientCommand);

        testBegin(DatabaseCommandMessageCancelSoftCheckDefaultWindowsJSONImpl.class);
    }
    ...
    public void teardownClass() {
        testEnd(DatabaseCommandMessageCancelSoftCheckDefaultWindowsJSONImpl.class);
    }
}
