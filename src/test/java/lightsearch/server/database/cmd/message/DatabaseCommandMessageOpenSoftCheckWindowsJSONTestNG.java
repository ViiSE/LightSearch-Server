...
public class DatabaseCommandMessageOpenSoftCheckWindowsJSONTestNG {
    ...
    public void setUpClass(String userIdent, String cardCode) {
        ...
        dbCmdMessage = new DatabaseCommandMessageOpenSoftCheckWindowsJSONImpl(clientCommand);

        testBegin(DatabaseCommandMessageOpenSoftCheckWindowsJSONImpl.class);
    }
    ...
    public void teardownClass() {
        testEnd(DatabaseCommandMessageOpenSoftCheckWindowsJSONImpl.class);
    }
}
