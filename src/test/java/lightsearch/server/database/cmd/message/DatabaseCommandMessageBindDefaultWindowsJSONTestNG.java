...
public class DatabaseCommandMessageBindDefaultWindowsJSONTestNG {
    ...
    public void setUpClass(String barcode, String factoryBarcode, String userIdent) {
        ...
        dbCmdMessage = new DatabaseCommandMessageBindDefaultWindowsJSONImpl(clientCommand);

        testBegin(DatabaseCommandMessageBindDefaultWindowsJSONImpl.class);
    }
    ...
    public void teardownClass() {
        testEnd(DatabaseCommandMessageBindDefaultWindowsJSONImpl.class);
    }
}
