...
public class DatabaseCommandMessageSearchWindowsJSONTestNG {
    ...
    public void setUpClass(String barcode, String sklad, String TK) {
        ...
        dbCmdMessage = new DatabaseCommandMessageSearchWindowsJSONImpl(clientCommand);

        testBegin(DatabaseCommandMessageSearchWindowsJSONImpl.class);
    }
    ...
    public void teardownClass() {
        testEnd(DatabaseCommandMessageSearchWindowsJSONImpl.class);
    }
}
