...
public class DatabaseCommandMessageSearchDefaultWindowsJSONTestNG {

    DatabaseCommandMessage dbCmdMessage;

    @BeforeClass
    @Parameters({"barcode", "sklad", "TK"})
    public void setUpClass(String barcode, String sklad, String TK) {
        String command = ClientCommands.SEARCH;
        ...
        dbCmdMessage = new DatabaseCommandMessageSearchDefaultWindowsJSONImpl(clientCommand);

        testBegin(DatabaseCommandMessageSearchDefaultWindowsJSONImpl.class);
    }
    ...
    public void teardownClass() {
        testEnd(DatabaseCommandMessageSearchDefaultWindowsJSONImpl.class);
    }
}
