...
public class DatabaseCommandMessageUnbindWindowsJSONTestNG {
    ...
    public void setUpClass(String factoryBarcode, String userIdent) {
        ...
        dbCmdMessage = new DatabaseCommandMessageUnbindWindowsJSONImpl(clientCommand);

        testBegin(DatabaseCommandMessageUnbindWindowsJSONImpl.class);
    }
    ...
    public void teardownClass() {
        testEnd(DatabaseCommandMessageUnbindWindowsJSONImpl.class);
    }
}
