...
public class DatabaseCommandMessageTKListDefaultWindowsJSONTestNG {

    DatabaseCommandMessage dbCmdMessage;

    @BeforeClass
    public void setUpClass() {
        String command = ClientCommands.TK_LIST;

        ClientCommand clientCommand = new ClientCommandSimpleImpl(command);
        dbCmdMessage = new DatabaseCommandMessageTKListDefaultWindowsJSONImpl(clientCommand);

        testBegin(DatabaseCommandMessageTKListDefaultWindowsJSONImpl.class);
    }
    ...
    public void teardownClass() {
        testEnd(DatabaseCommandMessageTKListDefaultWindowsJSONImpl.class);
    }
}
