...
public class DatabaseCommandMessageUnbindDefaultWindowsJSONTestNG {

    DatabaseCommandMessage dbCmdMessage;

    @BeforeClass
    @Parameters({"factoryBarcode", "userIdent"})
    public void setUpClass(String factoryBarcode, String userIdent) {
        String command = ClientCommands.UNBIND;
        ...
        dbCmdMessage = new DatabaseCommandMessageUnbindDefaultWindowsJSONImpl(clientCommand);

        testBegin(DatabaseCommandMessageUnbindDefaultWindowsJSONImpl.class);
    }
    ...
    public void teardownClass() {
        testEnd(DatabaseCommandMessageUnbindDefaultWindowsJSONImpl.class);
    }
}
