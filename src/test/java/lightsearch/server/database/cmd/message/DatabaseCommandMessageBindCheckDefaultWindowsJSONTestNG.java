...
public class DatabaseCommandMessageBindCheckDefaultWindowsJSONTestNG {
    ...
    public void setUpClass(String barcode, boolean checkEan13) {
        ...
        dbCmdMessage = new DatabaseCommandMessageBindCheckDefaultWindowsJSONImpl(clientCommand);

        testBegin(DatabaseCommandMessageBindCheckDefaultWindowsJSONImpl.class);
    }
    ...
    public void teardownClass() {
        testEnd(DatabaseCommandMessageBindCheckDefaultWindowsJSONImpl.class);
    }
}
