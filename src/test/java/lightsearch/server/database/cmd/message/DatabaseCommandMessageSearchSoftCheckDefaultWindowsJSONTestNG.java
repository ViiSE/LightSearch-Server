...
public class DatabaseCommandMessageSearchSoftCheckDefaultWindowsJSONTestNG {
    ...
    public void setUpClass(String barcode, String userIdent) {
        ...
        testBegin(DatabaseCommandMessageSearchSoftCheckDefaultWindowsJSONImpl.class);
    }
    ...
    public void teardownClass() {
        testEnd(DatabaseCommandMessageSearchSoftCheckDefaultWindowsJSONImpl.class);
    }
}
