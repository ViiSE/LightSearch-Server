...
public class DatabaseCommandMessageCloseSoftCheckDefaultWindowsJSONTestNG {
    ...
    public void setUpClass(String userIdent, String cardCode, String deivery) {
        ...
        dbCmdMessage = new DatabaseCommandMessageCloseSoftCheckDefaultWindowsJSONImpl(clientCommand);

        testBegin(DatabaseCommandMessageCloseSoftCheckDefaultWindowsJSONImpl.class);
    }
    ...
    public void teardownClass() {
        testEnd(DatabaseCommandMessageCloseSoftCheckDefaultWindowsJSONImpl.class);
    }
}
