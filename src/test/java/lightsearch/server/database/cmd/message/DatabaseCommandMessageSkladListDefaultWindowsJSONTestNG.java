...
public class DatabaseCommandMessageSkladListDefaultWindowsJSONTestNG {
    ...
    public void setUpClass() {
        ...
        dbCmdMessage = new DatabaseCommandMessageSkladListDefaultWindowsJSONImpl(clientCommand);

        testBegin(DatabaseCommandMessageSkladListDefaultWindowsJSONImpl.class);
    }
    ...
    public void teardownClass() {
        testEnd(DatabaseCommandMessageSkladListDefaultWindowsJSONImpl.class);
    }
}
