...
public class DatabaseCommandMessageTKListWindowsJSONTestNG {
    ...
    public void setUpClass() {
        ...
        dbCmdMessage = new DatabaseCommandMessageTKListWindowsJSONImpl(clientCommand);

        testBegin(DatabaseCommandMessageTKListWindowsJSONImpl.class);
    }
    ...
    public void teardownClass() {
        testEnd(DatabaseCommandMessageTKListWindowsJSONImpl.class);
    }
}
