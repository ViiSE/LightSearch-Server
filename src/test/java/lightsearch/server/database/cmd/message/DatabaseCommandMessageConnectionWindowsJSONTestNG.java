...
public class DatabaseCommandMessageConnectionWindowsJSONTestNG {
    ...
    public void setUpClass(String username, String password, String userIdent) {
        ...
        dbCmdMessage = new DatabaseCommandMessageConnectionWindowsJSONImpl(clientCommand);

        testBegin(DatabaseCommandMessageConnectionWindowsJSONImpl.class);
    }
    ...
    public void teardownClass() {
        testEnd(DatabaseCommandMessageConnectionWindowsJSONImpl.class);
    }
}
