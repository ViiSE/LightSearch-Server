...
public class CheckAuthProcessIntegrationTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void apply() throws JsonProcessingException {
        ClientCommandResult result = holder.get(ClientCommands.CHECK_AUTH).apply(null);
