...
public class CancelSoftCheckProcessIntegrationTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void apply(String userIdent, String cardCode) throws JsonProcessingException {
        ...
        ClientCommandResult result = holder.get(ClientCommands.CANCEL_SOFT_CHECK).apply(clientCommand);
