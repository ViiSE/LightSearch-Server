...
public class CloseSoftCheckProcessIntegrationTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void apply(String userIdent, String cardCode, String delivery) throws JsonProcessingException {
        ...
        ClientCommandResult result = holder.get(ClientCommands.CLOSE_SOFT_CHECK).apply(clientCommand);
