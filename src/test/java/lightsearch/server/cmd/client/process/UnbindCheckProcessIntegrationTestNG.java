...
public class UnbindCheckProcessIntegrationTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void apply(String barcode) throws JsonProcessingException {
        ClientCommand clientCommand = new ClientCommandWithBarcodeImpl(
                new ClientCommandSimpleImpl(
                        ClientCommands.UNBIND_CHECK),
                barcode);

        ClientCommandResult result = holder.get(ClientCommands.UNBIND_CHECK).apply(clientCommand);
