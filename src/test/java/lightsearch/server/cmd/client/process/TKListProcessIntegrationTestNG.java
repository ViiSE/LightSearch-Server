...
public class TKListProcessIntegrationTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void apply() throws JsonProcessingException {
        ClientCommand clientCommand = new ClientCommandSimpleImpl(ClientCommands.TK_LIST);

        ClientCommandResult result = holder.get(ClientCommands.TK_LIST).apply(clientCommand);
