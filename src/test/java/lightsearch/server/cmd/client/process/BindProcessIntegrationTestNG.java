...
public class BindProcessIntegrationTestNG extends AbstractTestNGSpringContextTests {
    ...
    @Test
    @Parameters({"barcodeForBind", "factoryBarcode", "userIdent"})
    public void apply(String barcode, String factoryBarcode, String userIdent) throws JsonProcessingException {
        ...
        ClientCommandResult result = holder.get(ClientCommands.BIND).apply(clientCommand);
