...
public class KeyRSAProcessIntegrationTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void apply() throws JsonProcessingException {
        ClientCommandResult result = holder.get(ClientCommands.KEY).apply(null);
