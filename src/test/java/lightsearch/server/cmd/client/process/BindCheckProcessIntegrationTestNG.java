...
public class BindCheckProcessIntegrationTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void apply(String barcode, boolean checkEan13) throws JsonProcessingException {
        ...
        ClientCommandResult result = holder.get(ClientCommands.BIND_CHECK).apply(clientCommand);
