...
public class SearchSoftCheckProcessIntegrationTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void apply(String barcode, String userIdent) throws JsonProcessingException {
        ...
        ClientCommandResult result = holder.get(ClientCommands.SEARCH_SOFT_CHECK).apply(clientCommand);
