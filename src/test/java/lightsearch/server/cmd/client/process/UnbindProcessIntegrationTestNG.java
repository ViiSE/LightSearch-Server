...
public class UnbindProcessIntegrationTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void apply(String factoryBarcode, String userIdent) throws JsonProcessingException {
        ...
        ClientCommandResult result = holder.get(ClientCommands.UNBIND).apply(clientCommand);
