...
public class LoginProcessIntegrationTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void apply(String IMEI, String ip, String os, String userIdent, String model, String username, String password) throws JsonProcessingException {
        ...
        ClientCommandResult result = holder.get(ClientCommands.LOGIN).apply(clientCommand);
