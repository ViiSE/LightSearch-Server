...
public class CommandCheckerAdminChangeDatabaseTestNG {
    ...
    public void setUpClass() {
        ...
        cmdChecker = new CommandCheckerAdminChangeDatabaseImpl(checker, portValidator);
    ...
    private AdminChangeDatabaseCommandDTO createAdminCommandDTO() {
        return createAdminCommandDTO("127.0.0.1", 8080, "firebird", "fire", "bird");
    }

    // TODO: 12.10.2020 UPDATE TEST
    private AdminChangeDatabaseCommandDTO createAdminCommandDTO(String ip, int port, String dbName, String dbUsername, String password) {
        AdminChangeDatabaseCommandDTO cmdDTO = new AdminChangeDatabaseCommandDTO();
        cmdDTO.setHost(ip);
        cmdDTO.setPort(port);
