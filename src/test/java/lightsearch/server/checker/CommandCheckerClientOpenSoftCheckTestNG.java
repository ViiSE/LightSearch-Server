...
public class CommandCheckerClientOpenSoftCheckTestNG {
    ...
    public void setUpClass() {
        ...
        cmdChecker = new CommandCheckerClientOpenSoftCheckImpl(checker);

        testBegin(CommandCheckerClientOpenSoftCheckImpl.class);
    }
    ...
    private ClientCommand createClientCommand(String cardCode, String userIdentifier) {
        return new ClientCommandWithUserIdentifierImpl(
                new ClientCommandWithCardCodeImpl(
                        new ClientCommandSimpleImpl(ClientCommands.OPEN_SOFT_CHECK),
                        cardCode),
                userIdentifier);
    }
    ...
    public void shutDownClass() {
        testEnd(CommandCheckerClientOpenSoftCheckImpl.class);
    }
}
