...
public class CommandCheckerClientUnbindCheckTestNG {
    ...
    public void setUpClass() {
        ...
        cmdChecker = new CommandCheckerClientUnbindCheckImpl(checker);

        testBegin(CommandCheckerClientUnbindCheckImpl.class);
    }

    @Test
    @Parameters({"barcode"})
    public void check_valid(String barcode) {
        testMethod("check()");

        ClientCommand cmd = createClientCommand(barcode);
        try {
    ...
    public void check_invalid(String barcode, String cause) throws CheckerException {
    ...
    public Object[][] createInvalidsData() {
        return new Object[][] {
                ...
                {null, "[invalid barcode (null)]"}
        };
    }

    private ClientCommand createClientCommand(String barcode) {
        return new ClientCommandWithBarcodeImpl(
                        new ClientCommandSimpleImpl(ClientCommands.UNBIND_CHECK),
                barcode);
    }

    @AfterClass
    public void shutDownClass() {
        testEnd(CommandCheckerClientUnbindCheckImpl.class);
    }
}
