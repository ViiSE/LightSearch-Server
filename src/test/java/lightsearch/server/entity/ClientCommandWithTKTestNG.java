...
public class ClientCommandWithTKTestNG {

    @Test
    @Parameters({"TK"})
    public void formForSend(String TK) throws JsonProcessingException {
        testBegin(ClientCommandWithTKImpl.class, "formForSend()");

        ClientCommand clientCommand = new ClientCommandWithTKImpl(
