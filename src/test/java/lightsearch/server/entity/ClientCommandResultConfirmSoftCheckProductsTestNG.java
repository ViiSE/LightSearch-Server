...
public class ClientCommandResultConfirmSoftCheckProductsTestNG {
    ...
    public void setUpClass() {
        ...
        resDTO.setMessage("ConfirmSoftCheckProducts");
        resDTO.setData(new ArrayList<>());

        commandResult = new ClientCommandResultConfirmSoftCheckProductsImpl(
                new ClientCommandResultFromDatabaseImpl(resDTO));

        testBegin(ClientCommandResultConfirmSoftCheckProductsImpl.class);
    }
    ...
    public void formForSend() throws IOException {
        ...
        ClientConfirmSoftCheckProductsCommandResultDTO cmdResDTO = (ClientConfirmSoftCheckProductsCommandResultDTO) commandResult.formForSend();
        System.out.println(TestUtils.objectMapperWithJavaTimeModule().writeValueAsString(cmdResDTO));
    }

    @AfterClass
    public void teardownClass() {
        testEnd(ClientCommandResultConfirmSoftCheckProductsImpl.class);
    }
}
