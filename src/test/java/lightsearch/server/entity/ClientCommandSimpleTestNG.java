...
public class ClientCommandSimpleTestNG {

    @Test
    public void formForSend() throws JsonProcessingException {
        testBegin(ClientCommandSimpleImpl.class, "formForSend()");

        ClientCommand clientCommand = new ClientCommandSimpleImpl(ClientCommands.LOGIN);
        ...
        testEnd(ClientCommandSimpleImpl.class, "formForSend()");
    }
}
