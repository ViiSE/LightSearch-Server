...
public class ClientCommandWithUsernameAndPasswordTestNG {

    @Test
    @Parameters({"username", "password"})
    public void formForSend(String username, String password) throws JsonProcessingException {
        testBegin(ClientCommandWithUsernameAndPasswordImpl.class, "formForSend()");

        ClientCommand clientCommand = new ClientCommandWithUsernameAndPasswordImpl(
        ...
        String uname = cmdDTO.getUsername();
        String pass = cmdDTO.getPassword();
        ...
        testEnd(ClientCommandWithUsernameAndPasswordImpl.class, "formForSend()");
    }
}
