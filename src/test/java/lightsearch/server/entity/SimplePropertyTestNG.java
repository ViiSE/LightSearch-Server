...
public class SimplePropertyTestNG {

    @Test
    @Parameters({"simpleName", "simpleValue"})
    public void as(String name, String value) {
        testBegin(SimplePropertyImpl.class, "as()");

        Property<String> property = new SimplePropertyImpl(name, value);
        assertEquals(property.as(), name + "=" + value);
