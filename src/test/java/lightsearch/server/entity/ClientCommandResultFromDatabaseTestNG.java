...
public class ClientCommandResultFromDatabaseTestNG {

    private ClientCommandResult clientCommandResult;
    ...
    public void setUpClass() {
        ...
        clientCommandResult = new ClientCommandResultFromDatabaseImpl(cmdResDTO);
    }

    @Test
    public void formForSend() throws IOException {
        testBegin(ClientCommandResultFromDatabaseImpl.class, "formForSend()");

        ClientCommandResultDTO ccrDTO = (ClientCommandResultDTO) clientCommandResult.formForSend();

        System.out.println(TestUtils
                .objectMapperWithJavaTimeModule()
                .writerWithDefaultPrettyPrinter()
                .writeValueAsString(ccrDTO));

        testEnd(ClientCommandResultFromDatabaseImpl.class, "formForSend()");
    }
}
