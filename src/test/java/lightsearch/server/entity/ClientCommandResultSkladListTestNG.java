...
import lightsearch.server.data.ClientSkladListCommandResultDTO;
...
public class ClientCommandResultSkladListTestNG {
    ...
    public void setUpClass() {
        ...
        resDTO.setMessage("SkladList");
        resDTO.setSkladList(new ArrayList<>());

        commandResult = new ClientCommandResultSkladListImpl(
                new ClientCommandResultFromDatabaseImpl(resDTO));

        testBegin(ClientCommandResultSkladListImpl.class);
    }
    ...
    public void formForSend() throws IOException {
        ...
        ClientSkladListCommandResultDTO cmdResDTO = (ClientSkladListCommandResultDTO) commandResult.formForSend();
        System.out.println(TestUtils.objectMapperWithJavaTimeModule().writeValueAsString(cmdResDTO));
    }

    @AfterClass
    public void teardownClass() {
        testEnd(ClientCommandResultSkladListImpl.class);
    }
}
