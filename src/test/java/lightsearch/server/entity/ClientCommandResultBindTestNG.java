...
public class ClientCommandResultBindTestNG {
    ...
    public void setUpClass() {
        ...
        resDTO.setMessage("Bind");

        commandResult = new ClientCommandResultBindImpl(
                new ClientCommandResultFromDatabaseImpl(resDTO));

        testBegin(ClientCommandResultBindImpl.class);
    }
    ...
    public void formForSend() throws IOException {
        ...
        ClientBindCommandResultDTO cmdResDTO = (ClientBindCommandResultDTO) commandResult.formForSend();
        System.out.println(TestUtils.objectMapperWithJavaTimeModule().writeValueAsString(cmdResDTO));
    }

    @AfterClass
    public void teardownClass() {
        testEnd(ClientCommandResultBindImpl.class);
    }
}
