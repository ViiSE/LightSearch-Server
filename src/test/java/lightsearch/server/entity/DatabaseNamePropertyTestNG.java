...
public class DatabaseNamePropertyTestNG {

    @Test
    @Parameters({"dbNameValue"})
    public void as(String value) {
        testBegin(SimplePropertyImpl.class, "as()");

        Property<String> property = new DatabaseNamePropertyImpl(value);
    ...
    public void name(String value) {
        ...
        Property<String> property = new DatabaseNamePropertyImpl(value);
        assertEquals(property.name(), "dbName");
