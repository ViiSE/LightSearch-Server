...
public class SpringDatasourceUsernamePropertyTestNG {
    ...
    public void as(String value) {
        ...
        Property<String> property = new SpringDatasourceUsernamePropertyImpl(value);
    ...
    public void name(String value) {
        ...
        Property<String> property = new SpringDatasourceUsernamePropertyImpl(value);
        assertEquals(property.name(), "spring.datasource.username");
