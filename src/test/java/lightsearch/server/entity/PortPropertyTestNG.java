...
public class PortPropertyTestNG {

    @Test
    @Parameters({"portValue"})
    public void as(int value) {
        testBegin(SimplePropertyImpl.class, "as()");

        Property<String> property = new PortPropertyImpl(value);
        assertEquals(property.as(), String.valueOf(value));
    ...
    public void name(int value) {
        ...
        Property<String> property = new PortPropertyImpl(value);
        assertEquals(property.name(), "port");
