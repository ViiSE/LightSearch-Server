...
public class ClientCommandWithDeliveryTestNG {

    @Test
    @Parameters({"delivery"})
    public void formForSend(String delivery) throws JsonProcessingException {
        testBegin(ClientCommandWithDeliveryImpl.class, "formForSend()");

        ClientCommand clientCommand = new ClientCommandWithDeliveryImpl(
