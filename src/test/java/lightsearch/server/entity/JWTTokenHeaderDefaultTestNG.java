...
public class JWTTokenHeaderDefaultTestNG {
    ...
    public void formForSend() throws JsonProcessingException {
        testBegin(JWTTokenHeaderDefaultImpl.class, "formForSend()");

        JWTTokenHeader tokenHeader = new JWTTokenHeaderDefaultImpl(
                mapper,
                token);
        ...
        testEnd(JWTTokenHeaderDefaultImpl.class, "formForSend()");
    }
}
